...
import com.meigsmart.huaapp.model.TypeModel;
...
public class SystemSetAdapter extends BaseAdapter<TypeModel> {
    private int[] res = {
            R.drawable.blue_group_invitation,R.drawable.blue_get_device_stat,R.drawable.blue_set_intervals,R.drawable.blue_get_log,R.drawable.blue_get_apn,
